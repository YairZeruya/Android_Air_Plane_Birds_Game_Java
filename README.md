In this game you control a small airplane as it tries to avoid collisions with the birds.Birds appear randomly on the way and must be dodged quickly to avoid a collision.
